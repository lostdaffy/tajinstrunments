...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { path: '/instruments-categories', label: 'Instruments' },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-sky-500 to-blue-600 bg-clip-text text-transparent">
              <Link to="/home">Taj Enterprises<span className="text-gray-400 ml-1">.</span></Link>
            </div>
            ...
            >
              <div className="w-6 h-6 relative">
                ...
                <span className={`absolute h-0.5 w-6 bg-current top-3 transition-all duration-300 ${menuOpen ? 'opacity-0' : 'opacity-100'}`}></span>
        ...
        >
          <div className="p-6">
            <div className="flex items-center justify-between mb-8">
              ...
              <button onClick={() => setMenuOpen(false)} className="p-2 rounded-lg text-gray-500 hover:bg-gray-100 focus:outline-none">
